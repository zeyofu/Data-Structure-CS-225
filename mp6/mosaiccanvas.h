...
class MosaicCanvas
{
  public:
     ...
     */
    void setTile(int row, int col, int index, const TileImage& img);
  ...
  private:
    ...
    map<TileImage*, PNG*> resized;

    // int images(int x, int y);
...
// inline int MosaicCanvas::images(int row, int col)
// {
