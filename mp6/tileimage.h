...
class TileImage {
  ...
  public:
    // void setResized(PNG& canvas, int startX, int startY, int resolution);
    PNG* getResized(int resolution);
    TileImage();
    ...
    // void paste(PNG& canvas, int startX, int startY, int resolution, PNG* resized);
