...
PNG* TileImage::getResized(int resolution) {
  PNG* resized_ = new PNG(resolution, resolution);
...
//
// void TileImage::setResized(PNG& canvas, int startX, int startY, int resolution) {
...
//               *(resized_.getPixel(x, y)) = p;
//               *(canvas.getPixel(startX + x, startY + y)) = p;
//
//           }
//       }
//   } else { // scaling is necessary
...
// void TileImage::paste(PNG& canvas, int startX, int startY, int resolution, PNG* resized) {
